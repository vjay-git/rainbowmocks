          ...
          {options.map((option, index) => (
            ...
            >
              <div className="text-center">
                <div className="text-lg font-bold text-gray-700 mb-1">{index + 1}</div>
                <div className="text-sm font-medium text-gray-600">{option}</div>
                {value === option && (
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-purple-50 to-violet-100 p-4">
      <div className="max-w-lg mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <button 
            onClick={onDashboard}
            className="flex items-center space-x-2 text-gray-600 hover:text-gray-900 transition-colors bg-white/80 backdrop-blur-sm border border-white/30 px-4 py-2 rounded-xl shadow-sm"
          >
            <span>←</span>
            <span>Dashboard</span>
          </button>
          ...
          {canGoPrevious && (
            <button 
              onClick={onPrevious}
              className="text-gray-600 hover:text-gray-900 transition-colors bg-white/80 backdrop-blur-sm border border-white/30 px-4 py-2 rounded-xl shadow-sm"
            >
              Previous
            </button>
          )}
  ...
  <div className="min-h-screen bg-gradient-to-br from-white via-purple-50 to-violet-100 flex items-center justify-center p-4">
    <div className="max-w-md mx-auto bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 text-center">
      ...
      <div className="bg-green-50 rounded-xl p-4 mb-6 text-left">
        <h3 className="font-semibold text-green-800 mb-2">Survey Completed</h3>
